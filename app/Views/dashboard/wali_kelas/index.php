                                    ...
                                    <div class='card-body'>
                                        <form method=" post" action="">
                                            ...
                                            <div class='form-group'>
                                                <fieldset disabled>
                                                    <label>Kelas</label>
                                                    <input type='text' name='class' placeholder="<?= $walas[0]['kelas']; ?>" class='form-control'>
                                                </fieldset>
                                            </div>
                                        </form>
                                    </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class='text-center' rowspan='2'>
                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#modal-form-edit-member" onclick="" class='btn btn-xs btn-success' title="Edit Anggota Kelas">
