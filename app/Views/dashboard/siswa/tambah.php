                            ...
                            <form method="post" action="<?= base_url("/siswa/proses_tambah") ?>">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text"
                                            ...
                                            id="" name="nis" value="<?= old('nis'); ?>" placeholder="nis" required>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text"
                                            ...
                                            id="" name="nisn" value="<?= old('nisn'); ?>" placeholder="nisn" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text"
                                            ...
                                            id="" name="nik" value="<?= old('nik'); ?>" placeholder="nik" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class='form-group col-md-3'>
                                        ...
                                        <input type='date' name='tanggal_lahir'
                                            ...
                                            value="<?= old('tanggal_lahir'); ?>" placeholder="tanggal diterima"
                                            required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class='form-group mt-2 col-md-2'>
                                        ...
                                        <input type='text' name='anak_ke'
                                            ...
                                            value="<?= old('anak_ke'); ?>" placeholder="anak ke" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class='form-group'>
                                    ...
                                    <textarea type='text' name='alamat_siswa' rows="3"
                                        ...
                                        value="<?= old('alamat_siswa'); ?>" placeholder="alamat siswa"
                                ...
                                <div class="form-row">
                                    <div class='form-group col-md-3'>
                                        ...
                                        <input type='text' name='no_hp_siswa'
                                            ...
                                            value="<?= old('no_hp_siswa'); ?>" placeholder="no handphone siswa"
                                            required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class='form-group col-md-3'>
                                        ...
                                        <input type='text' name='kelas_diterima'
                                            ...
                                            value="<?= old('kelas_diterima'); ?>" placeholder="kelas diterima" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class='form-group col-md-3'>
                                        ...
                                        <input type='date' name='tanggal_diterima'
                                            ...
                                            value="<?= old('tanggal_diterima'); ?>" placeholder="tanggal diterima"
                                            required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-row">
                                    <div class='form-group col-md-4'>
                                        ...
                                        <input type='text' name='pekerjaan_ayah'
                                            ...
                                            value="<?= old('pekerjaan_ayah'); ?>" placeholder="pekerjaan ayah" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class='form-group col-md-4'>
                                        ...
                                        <input type='text' name='pekerjaan_ibu'
                                            ...
                                            value="<?= old('pekerjaan_ibu'); ?>" placeholder="pekerjaan ibu" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class='form-group col-md-4'>
                                        ...
                                        <input type='text' name='no_telepon_ortu'
                                            ...
                                            value="<?= old('no_telepon_ortu'); ?>" placeholder="no telepon orang tua"
                                            required>
                                        <div class="invalid-feedback">
                                ...
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='nama_wali'
                                        ...
                                        value="<?= old('nama_wali'); ?>" placeholder="nama wali" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class='form-group'>
                                    ...
                                    <textarea type='text' name='alamat_wali' rows="3"
                                        ...
                                        value="<?= old('alamat_wali'); ?>" placeholder="alamat wali"
                                        required><?= old('alamat_wali'); ?></textarea>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-row">
                                    <div class='form-group col-md-3'>
                                        ...
                                        <input type='text' name='no_telepon_wali'
                                            ...
                                            value="<?= old('no_telepon_wali'); ?>" placeholder="no telepon wali"
                                            required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class='form-group col-md-3'>
                                        ...
                                        <input type='text' name='pekerjaan_wali'
                                            ...
                                            value="<?= old('pekerjaan_wali'); ?>" placeholder="pekerjaan wali" required>
                                        <div class="invalid-feedback">
