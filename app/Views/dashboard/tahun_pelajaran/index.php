...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            ...
            <?php if (!empty(session()->getFlashdata('peringatan'))) : ?>
                <div class="peringatan" data-flashdata="<?= session()->getFlashdata('peringatan'); ?>"></div>
            <?php endif; ?>
                        ...
                        <div class='card-body'>
                            <form method="post" action="<?= base_url("/TahunPelajaran/tambah"); ?>">
                                ...
                                <div class='form-group'>
                                    ...
                                    <input type='date' name='titimangsa_siswa_baru' class='form-control <?= ($validation->hasError('titimangsa_siswa_baru')) ? 'is-invalid' : ''; ?>' required placeholder="" value="<?= old('titimangsa_siswa_baru'); ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class='form-group'>
                                    ...
                                    <input type='date' name='titimangsa_semester_ganjil' class='form-control <?= ($validation->hasError('titimangsa_semester_ganjil')) ? 'is-invalid' : ''; ?>' required placeholder="" value="<?= old('titimangsa_semester_ganjil'); ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class='form-group'>
                                    ...
                                    <input type='date' name='titimangsa_semester_genap' class='form-control <?= ($validation->hasError('titimangsa_semester_genap')) ? 'is-invalid' : ''; ?>' required placeholder="" value="<?= old('titimangsa_semester_genap'); ?>">
                                    <div class="invalid-feedback">
