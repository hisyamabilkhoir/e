...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo base_url('AdminLTE/plugins'); ?>/overlayScrollbars/css/OverlayScrollbars.css">
    <link rel="stylesheet"
            ...
            <ul class="navbar-nav ml-auto">
                <li>
                    <div class="image mr-2">
                        <img src="<?= base_url('img/profile.png'); ?>" class="img-circle" width="30" height="30"
                            alt="User Image">
                        <a> - Administrtor |</a>
                    </div>
                </li>
                <li>
                    <div class="mt-1 text-red">
                        ...
                        <a class="text-decoration-none text-red" href="#" data-toggle="modal"
