<form method="post" action="<?= base_url('/TahunPelajaran/update'); ?>">
    ...
    <div class='form-group'>
        ...
        <input type='text' name='awal' value="<?= $tahunPelajaran['tahun_awal'] ?>" class='form-control' required
            placeholder="Tahun Awal">
    </div>
    <div class='form-group'>
        <label>Tahun Akhir</label>
        <input type='text' name='akhir' value="<?= $tahunPelajaran['tahun_akhir']; ?>" class='form-control' required
