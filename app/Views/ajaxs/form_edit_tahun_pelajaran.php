...
<form method="post" action="<?= base_url('/TahunPelajaran/update'); ?>">
    ...
    <div class='form-group'>
        ...
        <input type='text' name='update_awal' value="<?= $tahunPelajaran['tahun_awal'] ?>" class='form-control' required
            placeholder="Tahun Awal">
    </div>
    <div class='form-group'>
        <label>Tahun Akhir</label>
        <input type='text' name='update_akhir' value="<?= $tahunPelajaran['tahun_akhir']; ?>" class='form-control'
            required placeholder="Tahun Akhir">
    </div>
    <div class='form-group'>
        <label>Titimangsa Siswa Baru</label>
        <input type='date' name='titimangsa_siswa_baru' class='form-control' required placeholder=""
            value="<?= $tahunPelajaran['titimangsa_siswa_baru']; ?>">
    </div>
    <div class='form-group'>
        <label>Titimangsa Semester Ganjil</label>
        <input type='date' name='titimangsa_semester_ganjil' class='form-control' required placeholder=""
            value="<?= $tahunPelajaran['titimangsa_semester_ganjil']; ?>">
    </div>
    <div class='form-group'>
        <label>Titimangsa Semester Genap</label>
        <input type='date' name='titimangsa_semester_genap' class='form-control' required placeholder=""
            value="<?= $tahunPelajaran['titimangsa_semester_genap']; ?>">
    </div>
    <div class='form-group'>
        <label>
